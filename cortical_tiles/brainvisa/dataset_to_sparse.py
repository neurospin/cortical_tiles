...
for sulcus in tqdm(sulcus_list):
    for side in sides:
        root_save_dir = f'/neurospin/dico/data/cortical_tiles/current/datasets/UkBioBank40/crops/2mm/{sulcus}/sparse_load'
        data_dir = f'/neurospin/dico/data/cortical_tiles/current/datasets/UkBioBank40/crops/2mm/{sulcus}/mask'
