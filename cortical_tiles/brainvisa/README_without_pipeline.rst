...
as well as the cortical_tiles module following the steps described in `<../../README.rst>`_
...
.. code-block:: shell
   ...
   OUTPUT_DIR=/neurospin/dico/data/cortical_tiles/test
...
We then go to the cortical_tiles/brainvisa folder:

.. code-block:: shell

   cd cortical_tiles/brainvisa
...
* command_line_${SULCUS}_${SIDE}.sh: a bash file to reproduce the results (to be launched from cortical_tiles/brainvisa) 
