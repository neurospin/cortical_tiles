...
def resample(input_image: Union[str, aims.Volume],
    ...
    """
        ...
        values: []
            ...
            values. For Morphologist or cortical_tiles skeletons (see
            :func:`~cortical_tiles.brainvisa.utils.skeleton.generate_skeleton_thin_junction`)
        ...
        immortals:
            ...
            Morphologist or cortical_tiles skeleton: [30, 50, 80, 35, 110, 120].
            This is the default.
        redo_classif:
    ...
    if aims.version() >= (5, 2):
        ...
        if do_skel:
            ...
            tmp = tempfile.mkstemp(prefix='cortical_tiles_', suffix='.nii')
            os.close(tmp[0])
        ...
        if redo_classif and do_skel:
            ...
            # cortical_tiles value for external junction, 35, which are now
