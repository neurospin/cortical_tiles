...
if __name__ == '__main__':
    # save_to_pickle(
    #     cropped_dir='/neurospin/dico/data/cortical_tiles/current/crops/SC/mask/sulcus_based/2mm/Rlabels/',
    #     tgt_dir='/neurospin/dico/data/cortical_tiles/current/crops/SC/mask/sulcus_based/2mm/',
    #     file_basename='Rlabels')
    save_to_numpy(
        cropped_dir='/neurospin/dico/data/cortical_tiles/current/datasets/UkBioBank40/crops/2mm/F.I.P./mask/Rcrops/',
        tgt_dir='/neurospin/dico/data/cortical_tiles/current/datasets/UkBioBank40/crops/2mm/F.I.P./mask',
