...
if __name__ == '__main__':
    ...
    volume_path = "/neurospin/dico/data/cortical_tiles/current/datasets/UkBioBank/crops/2mm/CINGULATE/mask/Rlabels/sub-1000021_cropped_foldlabel.nii.gz"
    select_min = 6000
    select_max = 6999
    ...
    if len(sys.argv) == 2:
        ...
        # volume_path = "/neurospin/dico/data/cortical_tiles/current/datasets/UkBioBank/crops/2mm/CINGULATE/mask/Rcrops/sub-1000021_cropped_skeleton.nii.gz"
        # select_min = 35
        # select_max = 35
